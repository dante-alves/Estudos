...
//procedimento para deixar em português (fui testar se funcionava assim)
void pt(){
	setlocale(0, "Portuguese");
}

// função que verifica se o usuário deseja calcular mais algum cômodo.
...
// função que lê os dados e retorna a quantidade de cômodos inseridos
